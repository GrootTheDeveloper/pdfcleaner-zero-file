 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "            # Morphological close to find background mask (illumination)\n",
    ...
    "            # Divide image by background to flatten illumination\n",
    ...
    "        if contrast != 1.0 or True: # Always stretch for dynamic range\n",
    ...
    "            )\n",
    "        else:\n",
    "            # Otsu thresholding as alternative if global thresholding fallback needed\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        'blur_kernel_size': 3,\n",
    "        'enable_background_norm': False, # Keep original background\n",
    "        'gamma': 1.1,\n",
    "        'contrast': 1.1,\n",
    "        'enable_thresholding': False, # Do not binarize\n",
...
with open('notebooks/PDFCleaner_algorithm_demo.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1)
print("Wrote notebooks/PDFCleaner_algorithm_demo.ipynb successfully.")
